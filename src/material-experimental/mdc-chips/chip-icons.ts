...
export class MatChipTrailingIcon implements OnDestroy {
  ...
  constructor(
    public _elementRef: ElementRef, // TODO(crisbeto): currently the chip needs a reference to the trailing // icon for the deprecated `setTrailingActionAttr` method. Until the // method is removed, we can't use the chip here, because it causes a // circular import. private _chip: MatChip
  ) {
